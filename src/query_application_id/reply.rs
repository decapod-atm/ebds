...
/// Query Application ID - Reply (Subtype 0x0E)
///
/// This is the response to a query for the software part number of the application component of the device firmware.
///
/// The data returned by the device takes the form of an ASCII string that is 9 bytes long.
///
/// The Query Application ID Reply is formatted as follows:
///
...
impl QueryApplicationIdReply {
    /// Creates a new [QueryApplicationIdReply].
    pub fn new() -> Self {
...
impl fmt::Display for QueryApplicationIdReply {
...
mod tests {
    ...
    #[test]
    #[rustfmt::skip]
    fn test_query_application_id_reply_from_buf() -> Result<()> {
