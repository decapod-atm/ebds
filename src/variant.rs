...
inner_enum!(MessageVariant, AdvancedBookmarkModeReply);
inner_enum!(MessageVariant, ClearAuditDataRequestAck);
inner_enum!(MessageVariant, ClearAuditDataRequestResults);
inner_enum!(MessageVariant, ExtendedNoteReply);
inner_enum!(MessageVariant, ExtendedNoteInhibitsReplyAlt);
inner_enum!(MessageVariant, NoteRetrievedReply);
inner_enum!(MessageVariant, NoteRetrievedEvent);
inner_enum!(MessageVariant, QueryValueTableReply);
inner_enum!(MessageVariant, SetEscrowTimeoutReply);
inner_enum!(MessageVariant, QuerySoftwareCrcReply);
inner_enum!(MessageVariant, QueryBootPartNumberReply);
inner_enum!(MessageVariant, QueryApplicationPartNumberReply);
inner_enum!(MessageVariant, QueryVariantNameReply);
inner_enum!(MessageVariant, QueryVariantPartNumberReply);
inner_enum!(MessageVariant, QueryApplicationIdReply);
inner_enum!(MessageVariant, QueryVariantIdReply);
inner_enum!(MessageVariant, QueryDeviceCapabilitiesReply);
inner_enum!(MessageVariant, BaudRateChangeReply);
inner_enum!(MessageVariant, FlashDownloadReply7bit);
inner_enum!(MessageVariant, FlashDownloadReply8bit);
inner_enum!(MessageVariant, StartDownloadReply);
